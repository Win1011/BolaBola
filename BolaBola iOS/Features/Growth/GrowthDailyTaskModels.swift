...
final class GrowthDailyTasksViewModel: ObservableObject {
    ...
    func refreshProgress() async {
        ...
        next["drink_water_once"] = DailyInteractionTaskStore.drinkProgress(defaults: defaults)
        next["touch_bola_5"] = DailyInteractionTaskStore.touchProgress(defaults: defaults)
        next["feed_bola_once"] = DailyInteractionTaskStore.feedProgress(defaults: defaults)
